...
function Projects() {
    ...
    return (
        <div className="section-container">
            ...
            <div className="flex justify-center h-[60vh] gap-2">
                <div
                    className="text-2xl size-5 self-center rounded-full nf nf-fa-circle_chevron_left cursor-pointer"
                    onClick={() => handlePrev()}
                />
                ...
                <div
                    className="text-2xl size-5 self-center rounded-full nf nf-fa-circle_chevron_right cursor-pointer"
                    onClick={() => handleNext()}
                />
            </div>
        </div>
